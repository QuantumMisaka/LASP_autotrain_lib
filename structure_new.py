...
class Str(object):
    ...
    def genKPOINTS(self,outfile, criteria=25):
        ...
        '''
        ka = m.ceil(criteria / float(self.abc[0]))
        kb = m.ceil(criteria / float(self.abc[1]))
        kc = m.ceil(criteria / float(self.abc[2]))
...
#
    def transfer_toP_XYZ_coordStr(self):
        ...
        self.Coord = []
        for atom in self.atom:
            self.Ele_Name.append(atom.elesymbol)
            self.Ele_Index.append(atom.ele)
